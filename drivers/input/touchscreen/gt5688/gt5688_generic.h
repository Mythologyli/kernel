/* drivers/input/touchscreen/gt5688_generic.h
 *
...
#ifndef _GT5688_GENERIC_H_
#define _GT5688_GENERIC_H_
...
#define GTP_HEADER_FW_UPDATE  0	/* firmware in gt5688_firmware.h */
...
#define GTP_I2C_NAME                "Goodix-TS-GT5688"
#define GT5688_DEBUG_PROC_FILE        "gt5688_debug"
...
#define GTP_BAK_REF_PATH                "/data/gt5688_ref.bin"
#define GTP_MAIN_CLK_PATH               "/data/gt5688_clk.bin"
...
/* Export from gt5688_extents.c and gt5688_firmware.h */
#if GTP_HOTKNOT
extern u8 hotknot_enabled;
extern u8 hotknot_transfer_mode;
extern u8 gt5688_patch_jump_fw[];
...
extern s32 gt5688_init_node(void);
extern void gt5688_deinit_node(void);

#if GTP_GESTURE_WAKEUP
extern DOZE_T gesture_doze_status;
extern int gesture_enabled;
extern void gt5688_gesture_debug(int on) ;
...
/* Export from gt5688_tpd.c */
extern void gt5688_touch_down(s32 x, s32 y, s32 size, s32 id);
extern void gt5688_touch_up(s32 id);
extern int gt5688_power_switch(s32 state);
extern void gt5688_irq_enable(void);
extern void gt5688_irq_disable(void);
extern int gt5688_debug_proc(u8 *buf, int count);

struct fw_gt5688_update_info {
	int update_type;
	int status;
	int progress;
	int max_progress;
...
/* Export form gt5688_update.c */
extern struct fw_gt5688_update_info gt5688_update_info;

extern u8 gt5688_default_FW[];
extern int gt5688_hold_ss51_dsp(void);
extern int gt5688_auto_update_proc(void *data);
extern int gt5688_update_firmware(void *filename);
extern void gt5688_enter_update_mode(void);
extern void gt5688_leave_update_mode(void);
extern int gt5688_hold_ss51_dsp_no_reset(void);
extern int gt5688_load_patch(u8 *patch, u32 patch_size, int offset, int bank_size);
extern int gt5688_startup_patch(void);

/* Export from gt5688_tool.c */
#if GTP_CREATE_WR_NODE
extern int gt5688_init_tool_node(void);
extern void gt5688_deinit_tool_node(void);
#endif

/* Export from gt5688_generic.c */
extern struct i2c_client *gt5688_i2c_client;

extern CHIP_TYPE_T gt5688_chip_type;
extern struct gt5688_version_info gt5688_version;

extern s32 gt5688_do_i2c_read(struct i2c_msg *msgs, u16 addr, u8 *buffer, s32 len);
extern s32 gt5688_do_i2c_write(struct i2c_msg *msg, u16 addr, u8 *buffer, s32 len);
extern s32 gt5688_i2c_write(u16 addr, u8 *buffer, s32 len);
extern s32 gt5688_i2c_read(u16 addr, u8 *buffer, s32 len);
extern s32 gt5688_i2c_read_dbl_check(u16 addr, u8 *buffer, s32 len);

extern bool gt5688_ics_slot_report;
extern u8 gt5688_config[];
extern u32 gt5688_cfg_length;
extern u8 gt5688_int_type;
extern u8 gt5688_wakeup_level;
extern u32 gt5688_abs_x_max;
extern u32 gt5688_abs_y_max;
extern u8 gt5688_init_failed;
extern int gt5688_halt;
extern volatile int gt5688_rawdiff_mode;

extern s32 gt5688_init(void);
extern void gt5688_deinit(void);
extern s32 gt5688_read_version(struct gt5688_version_info *ver_info);
extern s32 gt5688_init_panel(void);
extern s32 gt5688_get_chip_type(void);
extern s32 gt5688_request_event_handler(void);
extern int gt5688_send_cmd(u8 cmd, u8 data);
extern s32 gt5688_send_cfg(u8 *config, int cfg_len);
extern void gt5688_select_addr(void);
extern s32 gt5688_reset_guitar(void);
extern void gt5688_power_reset(void);
extern int gt5688_parse_config(char *filename, u8 *gt5688_config);
extern s32 gt5688_touch_event_handler(u8 *data, struct input_dev *dev, struct input_dev *pen_dev);
extern int gt5688_suspend(void);
extern int gt5688_resume(void);

#if GTP_HAVE_TOUCH_KEY
extern const u16 gt5688_touch_key_array[];
#endif

#if GTP_WITH_STYLUS
extern struct input_dev *pen_dev;
extern void gt5688_pen_up(s32 id);
extern void gt5688_pen_down(s32 x, s32 y, s32 size, s32 id);
#endif

#if GTP_PROXIMITY
extern u8 gt5688_proximity_flag;
extern int gt5688_prox_event_handler(u8 *data);
#endif

#if GTP_SMART_COVER
extern int gt5688_parse_sc_cfg(int sensor_id);
#endif

#if GTP_ESD_PROTECT
extern void gt5688_init_esd_protect(void);
extern void gt5688_esd_switch(s32 on);
#endif

#if GTP_CHARGER_SWITCH
extern u32 gt5688_get_charger_status(void);
extern void gt5688_charger_switch(s32 on);
extern void gt5688_charger_config(s32 dir_update);
extern int gt5688_parse_chr_cfg(int sensor_id);
#endif
